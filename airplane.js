...
var _timjs$elm_collage$Collage$shift = F2(
	function (_p6, collage) {
		var _p7 = _p6;
		var _p8 = collage.shift;
		var x = _p8._0;
		var y = _p8._1;
		return _elm_lang$core$Native_Utils.update(
			collage,
			{
				shift: {ctor: '_Tuple2', _0: x + _p7._0, _1: y + _p7._1}
			});
	});
var _timjs$elm_collage$Collage$group = function (_p9) {
	return _timjs$elm_collage$Collage_Core$collage(
		_timjs$elm_collage$Collage_Core$Group(_p9));
};
var _timjs$elm_collage$Collage$opposite = function (_p10) {
	var _p11 = _p10;
	return {ctor: '_Tuple2', _0: 0 - _p11._0, _1: 0 - _p11._1};
};
...
var _user$project$Main$Model = F3(
	function (a, b, c) {
		return {x: a, y: b, clock: c};
	});
var _user$project$Main$model0 = A3(
...
var _user$project$Main$main = _elm_lang$html$Html$program(
	{
		init: {ctor: '_Tuple2', _0: _user$project$Main$model0, _1: _elm_lang$core$Platform_Cmd$none},
